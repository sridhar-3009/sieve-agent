...
Two kinds of graph ship in Sieve and conflating them made the UI say something
...
DISCOVERY, and why it is shaped this way: a module in sieve_agent/graph/workflows/ is
...
makes it testable. What makes a workflow runnable is its BINDER in sieve_agent/ops/,
where real callables meet the pure shape.

So the rule is: `sieve_agent/graph/workflows/<name>.py` plus `sieve_agent/ops/<name>.py`
