...
from sieve_agent.graph.engine import END, START, Graph, Node
from sieve_agent.graph.nodes import key_router
...
QUICK_REPLY_PROMPT = """\
You are Sieve, a warm, concise personal assistant. The user's message needs no
