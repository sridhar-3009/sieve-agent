"""MCP connector — plug any Model Context Protocol server into Sieve's tools.

Sieve's loop is synchronous; the MCP SDK is async. The bridge below runs one
