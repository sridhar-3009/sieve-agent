...
dir — so each scratch delegation instead lands in
    ...
    <SIEVE_WORKSPACE>/<YYYY-MM-DD>/<HHMMSS>-<model>-<slug>/
        <the files pi wrote>
...
lives OUTSIDE .sieve and is git-ignored — it never pollutes the agent's real
state or the repo.
...
WORKSPACE_ENV = "SIEVE_WORKSPACE"          # root dir; default ./waku_workspace
AUTORUN_ENV = "SIEVE_DELEGATE_AUTORUN"     # "0"/"false"/"no" to disable auto-run
RUN_TIMEOUT = int(os.getenv("SIEVE_AUTORUN_TIMEOUT", "30"))
