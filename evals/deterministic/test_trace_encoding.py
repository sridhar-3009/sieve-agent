...
from sieve_agent.ops.dashboard import collect, events_since
from sieve_agent.ops.tracing import TraceEncodingError, Tracer
...
def test_dashboard_ops_view_surfaces_trace_encoding_errors():
    views = (
        Path(__file__).resolve().parents[2] / "sieve_agent" / "ops" / "static" / "js" / "views.js"
