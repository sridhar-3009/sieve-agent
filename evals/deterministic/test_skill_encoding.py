...
from sieve_agent.memory.procedural import installer
from sieve_agent.memory.procedural.loader import SkillLoader
from sieve_agent.ops.dashboard import memory_action
from sieve_agent.tools.memory_admin import make_create_skill_tool
...
def test_installed_skill_is_written_as_utf8(
    ...
    monkeypatch.setenv("SIEVE_HOME", str(home))
