...
sieve_agent runs on your own machine, with your own API keys, and reads your own
...
[private vulnerability reporting](https://github.com/sridhar-3009/sieve-agent/security/advisories/new)
...
- **`SIEVE_EXPERIMENTAL=1`** enables sub-agent delegation, which runs another
  coding agent locally. It's off by default and documented as experimental.
- **Your own API keys in your own `.env`.** sieve_agent never sends them anywhere but
