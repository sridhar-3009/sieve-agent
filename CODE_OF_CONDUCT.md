...
sieve_agent is a teaching repo — a lot of the people opening their first-ever pull
...
- **Don't derail.** Issues are for the work; open a Discussion for everything else.
- **Credit people.** If someone's idea shaped a change, say so in the PR.

## Scope

This applies in issues, pull requests, reviews, commit messages, and anywhere
someone is representing the project.

## Enforcement

Report anything that crosses the line via a private message to a repo maintainer,
or GitHub's abuse reporting. Reports stay private.
